    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Error al cargar notificaciones</h2>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Descubre los nuevos libros disponibles en tus géneros favoritos</p>
        </div>
          ...
          <div className="text-center py-12">
            <div className="w-24 h-24 mx-auto mb-4 bg-gray-200 rounded-full flex items-center justify-center">
              <svg className="w-12 h-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.5 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4" />
              </svg>
            </div>
            <h3 className="text-xl font-medium text-gray-900 mb-2">No hay novedades</h3>
            <p className="text-gray-600">Cuando se publiquen nuevos libros en tus géneros suscritos, aparecerán aquí.</p>
          </div>
        ) : (
                      ...
                      <div className="flex-1">
                        ...
                        {notification.book && (
                          <div className="text-sm text-gray-600 mb-3">
                            <span className="font-medium">Libro:</span> {notification.book.title}
